...
public class MinuteIntervalPickerPreference extends DialogPreference {
	...
	public MinuteIntervalPickerPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
		setSummary("Time interval for location updates in seconds");
	}
